...
let fs = require("fs");
var endPointNetwork = "http://13.95.129.230:4563/";
...
exports.createPoll = async (req, res, next) => {
    try {
        ...
        console.log("Estimation du gaz : " + gasEstimate);
            ...
            var myContractReturned = await MyContract.new(req.body.question, optTab, voters, {
                from: currentAccount,
                data: byteCode,
                gas: 94000000 }, async function(err, myContract){
                    try{
                        if(!err) {
